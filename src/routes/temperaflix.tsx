              ...
              <div className="relative min-w-0 overflow-visible min-h-[420px] sm:min-h-[700px] flex items-end justify-center pb-[6%] lg:col-span-7">
                <FilmGate>
                  ...
                  <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                    ...
                    <div 
                      className="absolute top-[22%] left-1/2 -translate-x-1/2 w-[72%] aspect-[16/9] bg-black/60 rounded-md ring-1 ring-white/10"
                      style={{ 
                ...
                <motion.div
                  ...
                  style={{ width: "65%", height: "55%", top: "0%" }}
                />
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        animate={{ 
                          opacity: [0.3, 0.5, 0.3],
                          scale: [1, 1.1, 1],
                          y: 500 // Mantém a sombra no baú (delta de subida compensado para y: -360)
                        }}
                        transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
                        style={{
                          bottom: "-10px",
