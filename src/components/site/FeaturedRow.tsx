...
export function FeaturedRow({ products, label = "Em destaque" }: { products: ShopifyProduct[]; label?: string }) {
  ...
  return <section aria-label={label} className="relative min-w-0 overflow-hidden py-5 sm:py-8">
    ...
    <div ref={emblaRef} className="w-full min-w-0 overflow-hidden touch-pan-y cursor-grab active:cursor-grabbing"><div className="flex -ml-3 sm:-ml-6">{products.map((p, index) => {
