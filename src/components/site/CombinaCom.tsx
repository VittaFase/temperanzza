 ...
 * do tempero atual, excluindo o próprio e qualquer SKU fora do rebrand.
 */
  ...
  return (
    <section className="mt-16 lg:mt-24 border-t border-foreground/15 pt-12">
      <div className="flex items-center gap-3 mb-8">
        ...
        <span className="text-[10px] font-display uppercase tracking-[0.35em] text-foreground/60">Combina com</span>
      ...
      <p className="max-w-2xl mb-8 font-serif italic text-lg text-foreground/75">
        Temperos do mesmo perfil sensorial — pense em como se harmonizam num mesmo prato ou dividem espaço na sua prateleira.
      </p>
          ...
          return (
            ...
            >
              ...
              <div className="p-4 border-t border-foreground/10">
                <h3 className="font-display font-black uppercase text-sm tracking-tight leading-tight line-clamp-2">{p.node.title}</h3>
                <p className="mt-2 font-display font-black text-accent text-base">{formatBRL(price.amount, price.currencyCode)}</p>
              </div>
            </Link>
          );
        })}
