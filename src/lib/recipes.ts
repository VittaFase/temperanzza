...
export const RECIPES: Recipe[] = [
  ...
  // Nº46
  {
    slug: "bife-frango-curcuma",
    title: "Bife de frango com Cúrcuma",
    subtitle: "O dourado da saúde no seu grelhado.",
    intro: "Um grelhado simples que ganha vida e propriedades anti-inflamatórias com a cúrcuma pura.",
    featuredHandle: "curcuma",
    compatibleDiets: ["keto", "lowcarb", "carnivora-flex"],
    moment: "almoco",
    profile: "puras",
    ...
    difficulty: "Fácil",
    ingredients: [
      "400g de peito de frango em bifes",
      "1 colher (sopa) de azeite",
      "1 colher (chá) de Cúrcuma Temperanzza",
      "Sal e pimenta-do-reino a gosto"
    ],
    steps: [
      "Tempere os bifes com sal, pimenta e a Cúrcuma.",
      "Aqueça o azeite em uma frigideira antiaderente.",
      "Grelhe os bifes por 4 a 5 minutos de cada lado até dourarem.",
      "Deixe descansar 2 minutos antes de fatiar para manter a suculência."
    ],
    chefWord: "A cor vibrante da cúrcuma estimula o apetite. Adicione sempre uma pitada de pimenta-do-reino para ativar a curcumina.",
    whyItWorks: "Proteína magra com tempero funcional e zero sódio oculto.",
    substitution: "Pode ser feito com bifes de lombo suíno.",
    harmonization: ["lemon-pepper", "ana-maria"],
    relatedSlugs: ["frango-grelhado-ana-maria", "ovos-dourados-curcuma", "couve-flor-gratinada-curcuma", "legumes-assados-curcuma-tradicional"],
    dish: { src: "/receitas/bife-frango-curcuma.jpg", alt: "Bife de frango com Cúrcuma" },
    hero: { color: "oklch(0.75 0.16 80)" },
  },
  // Nº47
  {
    slug: "omelete-espinafre-salsa-cebola-alho",
    title: "Omelete de espinafre com Salsa, Cebola e Alho",
    subtitle: "Verde, proteico e aromático.",
    intro: "Omelete nutritivo que utiliza a base clássica de salsa, cebola e alho para um sabor completo.",
    featuredHandle: "salsa-cebola-e-alho",
    compatibleDiets: ["keto", "lowcarb"],
    moment: "jantar",
    profile: "ervas",
    ...
    ingredients: [
      ...
      "1 colher (sopa) de queijo minas padrão ralado",
      "1 colher (chá) de Salsa, Cebola e Alho Temperanzza",
      "1 colher (chá) de manteiga",
      "Sal a gosto"
    ],
    steps: [
      "Refogue o espinafre na manteiga até murchar.",
      "Bata os ovos com o sal, o queijo e a Salsa, Cebola e Alho.",
      "Despeje os ovos sobre o espinafre na frigideira.",
      "Cozinhe em fogo baixo, dobre ao meio e sirva quando o queijo derreter."
    ],
    chefWord: "O espinafre solta água, então refogá-lo primeiro garante que o omelete não fique 'aguado'. O tempero traz o aroma de refogado fresco.",
    whyItWorks: "Fibras, ferro e proteína com baixo índice glicêmico.",
    substitution: "Substitua o espinafre por couve ou manjericão.",
    harmonization: ["ervas-finas", "curcuma"],
    relatedSlugs: ["ovos-mexidos-ervas-finas", "omelete-temperaflix-ervas-finas", "ovos-cozidos-tempero-edu", "omelete-bacon-em-po"],
    dish: { src: "/receitas/omelete-espinafre-salsa-cebola-alho.jpg", alt: "Omelete de espinafre com Salsa, Cebola e Alho" },
    hero: { color: "oklch(0.6 0.12 145)" },
  },
  // Nº48
  {
    slug: "costelinha-suina-chimichurri",
    title: "Costelinha suína com Chimichurri",
    subtitle: "O sabor do pampa na sua mesa mineira.",
    intro: "Costelinha assada lentamente, finalizada com a potência herbal do chimichurri.",
    ...
    difficulty: "Médio",
    ingredients: [
      "1kg de costelinha suína em ripas",
      "2 colheres (sopa) de Chimi Churri sem Pimenta Temperanzza",
      "3 colheres (sopa) de azeite",
      "1 colher (sopa) de vinagre de maçã",
      "Sal grosso a gosto"
    ],
    steps: [
      "Misture o Chimichurri com o azeite e o vinagre para hidratar.",
      "Salgue a costelinha e pincele metade do molho de ervas.",
      "Asse em forno a 180°C coberta com alumínio por 1 hora.",
      "Retire o papel, pincele o restante do molho e asse por mais 20 minutos até dourar."
    ],
    chefWord: "Hidratar o chimichurri no azeite e vinagre antes de usar 'acorda' os aromas das ervas secas, criando um molho vibrante para a carne gorda.",
    whyItWorks: "Gordura suína realçada por ervas e acidez.",
    substitution: "Use a versão picante para um toque extra de calor.",
    harmonization: ["paprica-defumada", "lemon-pepper"],
    relatedSlugs: ["costelinha-paprica-defumada-tradicional", "costela-porco-du-chefe", "porco-assado-paprica-picante", "bife-manteiga-chimi-churri"],
    dish: { src: "/receitas/costelinha-suina-chimichurri.jpg", alt: "Costelinha suína com Chimichurri" },
    hero: { color: "oklch(0.45 0.12 30)" },
  },
  // Nº49
  {
    slug: "salada-frango-ervas-finas",
    title: "Salada de frango com Ervas Finas",
    subtitle: "Leveza e frescor para dias quentes.",
    intro: "Uma salada completa onde o frango ganha sofisticação com o blend de ervas europeias.",
    featuredHandle: "ervas-finas",
    compatibleDiets: ["keto", "lowcarb"],
    moment: "almoco",
    profile: "ervas",
    ...
    ingredients: [
      ...
      "1 colher (sopa) de Ervas Finas Temperanzza",
      "Azeite e limão para o molho"
    ],
    steps: [
      "Tempere o frango desfiado com as Ervas Finas e um fio de azeite.",
      "Em uma travessa, disponha as folhas, o tomate e o pepino.",
      "Coloque o frango temperado por cima.",
      "Finalize com molho de azeite, limão e mais uma pitada de ervas."
    ],
    chefWord: "O segredo de uma boa salada é o tempero da proteína. O Ervas Finas tira o frango desfiado da monotonia.",
    whyItWorks: "Refeição fria rica em fibras e proteína de alto valor biológico.",
    substitution: "Substitua o frango por ovos cozidos ou queijo branco.",
    harmonization: ["salsa-cebola-e-alho", "lemon-pepper"],
    relatedSlugs: ["ovos-mexidos-ervas-finas", "salmao-crosta-ervas-finas", "sopa-legumes-ervas-finas", "abacate-recheado-frango-chimi-churri"],
    dish: { src: "/receitas/salada-frango-ervas-finas.jpg", alt: "Salada de frango com Ervas Finas" },
    hero: { color: "oklch(0.55 0.12 145)" },
  },
  // Nº50
  {
    slug: "picadinho-carne-tempero-mineiro",
    title: "Picadinho de carne com Tempero Mineiro",
    subtitle: "O sabor da fazenda em cubinhos suculentos.",
    intro: "Carne picada na faca com o blend que é a alma de Minas Gerais.",
    featuredHandle: "tempero-mineiro",
    compatibleDiets: ["keto", "lowcarb", "carnivora-flex"],
    moment: "jantar",
    profile: "casa",
    ...
    difficulty: "Fácil",
    ingredients: [
      "400g de filé mignon ou alcatra em cubos pequenos",
      "1 colher (sopa) de manteiga ou banha",
      "1 colher (sopa) de Tempero Mineiro Temperanzza",
      "1/2 xícara de caldo de carne caseiro ou água",
      "Sal a gosto"
    ],
    steps: [
      "Doure a carne na gordura em fogo bem alto para não soltar água.",
      "Junte o Tempero Mineiro e refogue por 1 minuto.",
      "Adicione o líquido e deixe reduzir até formar um molho encorpado.",
      "Ajuste o sal e sirva com couve refogada."
    ],
    chefWord: "Picadinho precisa de molho, mas não de sopa. O Tempero Mineiro já traz o sabor de refogado longo em poucos minutos de frigideira.",
    whyItWorks: "Carne vermelha rica em ferro com tempero natural mineiro.",
    substitution: "Pode ser feito com carne de porco.",
    harmonization: ["ana-maria", "pimenta-do-reino"],
    relatedSlugs: ["carne-moida-tempero-mineiro", "carne-panela-batatas-tempero-mineiro", "feijao-tropeiro-tempero-mineiro", "figado-acebolado-salsa-cebola-alho"],
    dish: { src: "/receitas/picadinho-carne-tempero-mineiro.jpg", alt: "Picadinho de carne com Tempero Mineiro" },
    hero: { color: "oklch(0.42 0.1 35)" },
  },
  ];
