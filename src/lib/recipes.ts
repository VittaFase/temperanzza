...
export const RECIPES: Recipe[] = [
  ...
  // Nº06
  {
    ...
    title: "Bife grelhado com manteiga de Chimichurri Picante",
    ...
    ingredients: [
      ...
      "1 colher (chá) cheia de Chimichurri Picante Temperanzza",
      "Sal grosso a gosto",
    ],
    steps: [
      "Misture a manteiga com o Chimichurri Picante e reserve fora da geladeira.",
    ...
    whyItWorks: "Carne vermelha é pilar low carb e cetogênica; o Chimichurri, por ser mix de ervas, é aceito na carnívora flexível.",
    substitution: "Sem picância? O Chimichurri sem Pimenta faz a mesma manteiga.",
    ...
    dish: { src: bifeChimiAsset.url, alt: "Bife grelhado com manteiga de Chimichurri Picante" },
  ...
  // Nº14
  {
    ...
    title: "Camarão salteado com Chimichurri Picante",
    ...
    ingredients: [
      ...
      "1 colher (chá) de Chimichurri Picante Temperanzza",
      "Suco de meio limão siciliano",
      "Sal a gosto",
    ],
    steps: [
      "Aqueça a frigideira com a manteiga em fogo alto.",
      "Coloque os camarões e o Chimichurri Picante simultaneamente.",
    ...
    dish: { src: camaraoChimiAsset.url, alt: "Camarão salteado com Chimichurri Picante" },
  ...
  // Nº19
  {
    ...
    title: "Abacate recheado com frango e Chimichurri",
    ...
    ingredients: [
      ...
      "1 colher (chá) de Chimichurri sem Pimenta Temperanzza",
      "Sal e limão a gosto",
    ],
    steps: [
      "Misture o frango desfiado com a maionese, sal, limão e o Chimichurri.",
    ...
    chefWord: "Abacate é a 'manteiga da natureza' para quem faz keto. O Chimichurri traz a acidez e as ervas que equilibram a gordura da fruta.",
    whyItWorks: "Combo perfeito de gordura boa (abacate) e proteína (frango). O Chimichurri é o blend vegetal ideal.",
    ...
    dish: { src: abacateFrangoAsset.url, alt: "Abacate recheado com frango e Chimichurri" },
  ...
  // Nº35
  {
    ...
    title: "Frango grelhado com Chimichurri Picante",
    ...
    steps: [
      "Tempere o frango com sal e o Chimichurri Picante.",
    ...
    chefWord: "O Chimichurri Picante tem a acidez do vinagre e o calor da pimenta que transformam o frango do dia a dia em uma experiência gastronômica.",
    ...
    dish: { src: frangoChimiPicanteAsset.url, alt: "Frango grelhado com Chimichurri Picante" },
    hero: { color: "rgba(26, 26, 26, 0.95)" },
  },
  // Nº36
  {
  ...
  // Nº45
  {
    ...
    title: "Pão Carnívoro Tradicional",
    subtitle: "A volta da textura à mesa — sem pão, sem glúten, sem inflamação.",
    intro: "Um pão fofinho e nutritivo feito apenas com ovos, queijo e os temperos certos da Temperanzza.",
    featuredHandle: "ervas-finas",
    compatibleDiets: ["keto", "lowcarb", "carnivora-flex"],
    moment: "cafe",
    profile: "ervas",
    ...
    ingredients: [
      ...
      "1 colher (sopa) de Ervas Finas Temperanzza",
      "1 pitada de Tempero Mineiro Temperanzza",
      "1/2 colher (chá) de fermento químico",
    ],
    steps: [
      "Bata as claras em neve até ficarem bem firmes.",
      "Em outra tigela, misture as gemas, o requeijão, o parmesão e os temperos Temperanzza até obter um creme liso.",
      "Incorpore delicadamente as claras em neve ao creme, sem bater.",
      "Adicione o fermento e misture suavemente.",
      "Despeje em uma forma de pão untada e leve ao forno pré-aquecido a 180°C por 30-35 minutos.",
    ],
    chefWord: "O segredo para não ter gosto de ovo é a aeração das claras e o uso generoso das Ervas Finas, que perfumam a massa por inteiro.",
    whyItWorks: "Base 100% proteica, perfeita para substituir o pão francês.",
  ...
  // Nº46
  {
    ...
    title: "Pão de Hambúrguer Carnívoro",
    subtitle: "O sanduíche completo, sem o peso do carboidrato.",
    intro: "Uma versão mais firme e moldada do pão carnívoro, ideal para hambúrgueres gourmet.",
    featuredHandle: "lemon-pepper",
    compatibleDiets: ["keto", "lowcarb", "carnivora-flex"],
    moment: "jantar",
    profile: "citrico-picante",
    ...
    ingredients: [
      "2 ovos",
      "50 g de carne moída bem fina (opcional para textura)",
      "50 g de muçarela ralada",
      "1 colher (chá) de Lemon Pepper Temperanzza",
      "Páprica Defumada para polvilhar",
    ],
    steps: [
      "Misture todos os ingredientes (exceto a páprica) em uma tigela.",
      "Divida a massa em dois aros de silicone ou formas circulares pequenas.",
      "Polvilhe Páprica Defumada por cima para dar cor e aroma.",
      "Leve ao forno a 200°C por 15-20 minutos ou até dourar bem.",
    ],
    chefWord: "O Lemon Pepper traz a acidez necessária para contrastar com a gordura do queijo e da carne do hambúrguer.",
    whyItWorks: "Mantém a estrutura do hambúrguer sem absorver umidade excessiva.",
    substitution: "Use Chimichurri para um perfil mais argentino.",
  ...
  // Nº47
  {
    ...
    title: "Torradas Carnívoras Temperanzza",
    subtitle: "Crocância absoluta para caldos e antepastos.",
    intro: "Fatias de pão carnívoro levadas à perfeição crocante com o blend exclusivo da casa.",
    featuredHandle: "tempero-mineiro",
    compatibleDiets: ["keto", "lowcarb", "carnivora-flex"],
    moment: "lanche",
    profile: "casa",
    ...
    difficulty: "Fácil",
    ingredients: [
      "4 fatias de Pão Carnívoro Tradicional",
      "1 colher (sopa) de manteiga",
      "1 colher (chá) de Tempero Mineiro Temperanzza",
      "Chimichurri a gosto",
    ],
    steps: [
      ...
      "Polvilhe o Tempero Mineiro e o Chimichurri na manteiga derretida.",
      "Coloque as fatias de pão e grelhe até ficarem bem crocantes e douradas dos dois lados.",
    ],
    chefWord: "O segredo da torrada carnívora é a manteiga temperada; ela penetra na trama proteica do pão e cria uma crosta inesquecível.",
    whyItWorks: "Ideal para quem sente falta de 'crocância' em dietas restritivas.",
