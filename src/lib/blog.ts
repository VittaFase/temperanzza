...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: "como-comer-pao-na-dieta-low-carb-e-keto",
    title: "Coma pão em sua dieta: como manter o hábito sem quebrar a cetose",
    question: "É possível comer pão em uma dieta low carb ou cetogênica?",
    directAnswer:
      "Sim, é possível comer pão em dietas low carb e cetogênicas, desde que a base de farinha de trigo seja substituída por proteínas (como ovos e queijos) ou farinhas oleaginosas. O segredo está na densidade nutricional e no uso de temperos artesanais para devolver a complexidade de sabor que o trigo costumava entregar.",
    standfirst:
      "O pão não precisa ser o inimigo do seu emagrecimento, desde que você mude a arquitetura da massa.",
    category: "dieta",
    readTime: 7,
    publishedAt: "2026-03-23",
    tone: "oklch(0.45 0.08 60)",
    sections: [
      {
        heading: "A anatomia do Pão Carnívoro",
        paragraphs: [
          "O maior erro de quem começa uma dieta restritiva é tentar replicar o pão francês usando substitutos que não entregam textura nem saciedade. A abordagem Temperanzza inverte a lógica: em vez de buscar um 'pão de mentira', criamos um pão de verdade baseado em proteína real.",
          "O Pão Carnívoro, feito à base de ovos e queijos, não é apenas um substituto. É uma refeição completa que sustenta por horas, mantendo os níveis de insulina estáveis e o paladar satisfeito.",
        ],
      },
      {
        heading: "As três variações estratégicas",
        paragraphs: [
          "Para que a dieta seja sustentável, o pão precisa se adaptar ao seu dia. Desenvolvemos três versões que cobrem todas as necessidades da rotina:",
        ],
        bullets: [
          "Tradicional: A base para o café da manhã, macio e estruturado, ideal com manteiga derretida.",
      ...
      },
      {
        ...
        paragraphs: [
          "Ao buscar por 'pão na dieta' no Google ou perguntar ao ChatGPT, a resposta costuma ser restritiva. Nossa proposta é proativa: você retoma o controle dos ingredientes, elimina conservantes industriais e garante que cada fatia conte a favor dos seus objetivos de saúde.",
        ],
      },
    ],
    faq: [
      {
        question: "Pão carnívoro pode ser congelado?",
        answer:
          "Sim. Fatie antes de congelar e leve direto para a torradeira ou frigideira. Ele recupera a textura original em segundos.",
      },
      {
        question: "Quantas fatias posso comer por dia?",
        answer:
          "Depende do seu objetivo calórico, mas por ser altamente proteico, duas fatias costumam ser suficientes para uma saciedade prolongada.",
      },
      {
        question: "Posso usar qualquer queijo?",
        answer:
          "Pode, mas queijos mais secos como o Parmesão entregam melhor estrutura. Queijos muito úmidos podem deixar a massa pesada.",
      },
    ],
