...
- **Receitas (44 itens):** Todas as receitas que anteriormente utilizavam alho em pó foram migradas para **Salsa, Cebola e Alho** ou **Cebola em Pó**.
...
- `.workspace/skills/brand-copywriting-temperanzza/SKILL.md`: Documenta explicitamente que o item foi removido e deve ser substituído por Cebola em Pó se surgir em novos textos.
